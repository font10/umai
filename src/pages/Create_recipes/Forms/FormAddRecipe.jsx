...
export const FormAddRecipe = ({ preview, image }) => {
    ...
    return (
        <form onSubmit={uploadImage}>
            <div className='flex flex-col'>
                ...
                <input type="text" id="name" placeholder="Enter name of recipe" name="name" required className='border p1 text-sm h-[40px] rounded-md ps-3' onChange={handleChange} />
            </div>
            ...
            <div className='flex flex-col mt-3'>
                ...
                <input type="text" id="description" required placeholder="Enter description of recipe" name="description" className='border p1 text-sm h-[40px] rounded-md ps-3' onChange={handleChange} />
            </div>
            ...
            <div className='flex flex-col xl:flex-row justify-between w-full gap-5'>
                <div className='flex flex-col w-full xl:w-1/2'>
                    ...
                    <input type="number" id="cookingTime" required name="cookingTime" className='border p-1 h-[40px] rounded-md ps-5' onChange={handleChange} />
                </div>
                <div className='flex flex-col w-full xl:w-1/2'>
                    <label htmlFor='servers' className='text-[13px] text-gray-500 font-semibold mt-2 mb-2'>Servers</label>
                    <input type="number" id="servers" required name="servers" className='border p-1 h-[40px] rounded-md ps-5' onChange={handleChange} />
                </div>
            </div>
